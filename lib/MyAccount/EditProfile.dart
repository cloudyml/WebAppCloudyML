...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  void initState() {
    ...
    _email = Provider.of<UserProvider>(context, listen: false)
        .userModel
        ?.email
        .toString();
    _username = Provider.of<UserProvider>(context, listen: false)
        .userModel
        ?.name
        .toString();
    _mobile = Provider.of<UserProvider>(context, listen: false)
        .userModel
        ?.mobile
        .toString();
  }
              ...
              Positioned(
                ...
                child: IconButton(
                  icon: Icon(
                    Icons.arrow_back,
                    color: Colors.white,
                    size: 36 * min(horizontalScale, verticalScale),
                  ),
                  onPressed: () async {
                    FocusScope.of(context).requestFocus(new FocusNode());
              ...
              Center(
                child: Column(
                  children: [
                    ...
                    Align(
                      ...
                      child: InkWell(
                        onTap: () {
                          ...
                          _selectImagex(_picker.pickImage(
                        ...
                        child: SizedBox(
                          child: Container(
                            ...
                            child: CircleAvatar(
                              radius:
                                  min(horizontalScale, verticalScale) * 32.0,
                              ...
                              child: Container(
                                ...
                                child: CircleAvatar(
                                    ...
                                    child: Align(
                                      ...
                                      child: CircleAvatar(
                                        radius: min(horizontalScale,
                                                verticalScale) *
                                            26,
                                        backgroundColor: Colors.white,
                                        child: Icon(
                                          Icons.edit,
                                          size: min(horizontalScale,
                                                  verticalScale) *
                                              30,
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              readOnly: ((userprovider.userModel?.authType ==
                                              'emailAuth' &&
                                          userprovider
                                                  .userModel?.phoneVerified ==
                                              true) ||
                    ...
                    (userprovider.userModel?.phoneVerified == true &&
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Icon(
                                  ...
                                  color: Colors.green,
                                  size:
                                      22 * min(horizontalScale, verticalScale),
                                )
                              ],
                            ),
                          )
                    ...
                    (userprovider.userModel?.authType == 'emailAuth' &&
                        ...
                        ? Padding(
                            padding: EdgeInsets.fromLTRB(
                                ...
                                verticalScale * 0),
                            child: Text(
                              'Note: To change the phone number you have to unlink the phone from the account.',
                              textScaleFactor:
                                  min(horizontalScale, verticalScale),
                                            ...
                                            children: [
                                              ...
                                              ElevatedButton(
                                                onPressed: () async {
                                                  ...
                                                  await Future.delayed(Duration(
                                                      milliseconds: 70));
                                                  User? usernew = FirebaseAuth
                                                      .instance.currentUser;
                                                  List<UserInfo> providerData =
                                                      usernew!.providerData;
                            ...
                            children: [
                              ...
                              Padding(
                                  padding: EdgeInsets.fromLTRB(
                                      ...
                                      horizontalScale * 24,
                                      verticalScale * 4),
                                  child: (userprovider.userModel?.authType ==
                                          'googleAuth')
                                      ? Text(
                                          'Gmail address',
                                          textScaleFactor: min(
                              ...
                              (FirebaseAuth.instance.currentUser
                                              ?.emailVerified ==
                                          true &&
                                      _email == userprovider.userModel?.email)
                                  ? Padding(
                                      padding: EdgeInsets.fromLTRB(
                                          horizontalScale * 24,
                                          verticalScale * 0,
                              ...
                              (userprovider.userModel?.authType == 'googleAuth')
                                  ? Text(
                                      'Note: Gmail address cannot be changed',
                                      textScaleFactor:
                                          min(horizontalScale, verticalScale),
                                      style: TextStyle(
                                          color: HexColor('#d91f2a'),
