...
class _PaymentScreenState extends State<PaymentScreen> with CouponCodeMixin {
  ...
  void url_del() {
    ...
    FirebaseFirestore.instance.collection('Notice')
      ..doc("HX4neryeAOB1dzUeIAg1_prompt").update({'url': ""}).whenComplete(() {
...
// Search for the coupon in the Coupons collection
  Future<dynamic> searchCouponInCouponsCollection(
    ...
    try {
      ...
      return {
        "Success": true,
        "message": json.encode({"result": couponData})
      };
    } catch (e) {
                                                                ...
                                                                if (couponAPI !=
                                                                  ...
                                                                  if (value['result']
                                                                    ...
                                                                    if (DateTime
                                                                      ...
                                                                      'scholarship') {
                                                                    print(
                                                                        "yyyhbhyguv ${value['result']['couponExpiryDate'].runtimeType}");
                                                                    var endTime =
                                                                        json.decode(
                                                          ...
                                                          if (couponAPI !=
                                                            ...
                                                            if (value['result'][
                                                              ...
                                                              if (DateTime.now()
                                                                ...
                                                                'individual') {
                                                              print(
                                                                  "stsaryt ${value['result']['couponExpiryDate'].runtimeType}");
                                                              var endTime = value[
                                                                      'result'][
                                                                  'couponExpiryDate'];
