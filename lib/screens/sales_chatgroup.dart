...
import 'package:cloudyml_app2/screens/sales_chatscreen.dart';
...
class SalesGroupPage extends StatefulWidget { 
  Map<String, dynamic>? groupData;
  Map? userData;
  SalesGroupPage({this.groupData, this.userData});
  @override
  State<SalesGroupPage> createState() => _SalesGroupPageState();
}
...
class _SalesGroupPageState extends State<SalesGroupPage> {
