...
import 'package:cloudyml_app2/screens/cxchat_screen.dart';
...
class CXGroupPage extends StatefulWidget { 
  Map<String, dynamic>? groupData;
  Map? userData;
  CXGroupPage({this.groupData, this.userData});
  @override
  State<CXGroupPage> createState() => _CXGroupPageState();
}
...
class _CXGroupPageState extends State<CXGroupPage> {
