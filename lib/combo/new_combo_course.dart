                    ...
                    builder: (controller) {
                      return !controller.paidCourse.contains(widget.courseIdd)
                          ...
                          : controller.courseList.isEmpty
                              ...
                              : Obx(
                                  () => Padding(
                                    padding:  EdgeInsets.symmetric(horizontal: width > 700
                                                ? width / 7
                                                : width / 50),
                                    child: SizedBox(
                                    ...
                                    dynamic item =  controller.courseList.removeAt(oldIndex);
                                    controller.courseList.insert(newIndex, item);
 List newCourseList = [];
 newCourseList.clear();
controller.courseList.forEach((element) { 
newCourseList.add(element['id']);
});

                                   await controller.updateModuleOrder(newList: newCourseList);
                                                                 
                                                                }, 
                                        children: List.generate(controller.courseList.length,
                                    (index) {
