...
class _LoginEmailPageState extends State<LoginEmailPage> {
  ...
  void url() async {
    ...
    globals.trial_link = '';
    ;
    print("url1 is at login=====${globals.schurl}");
    print("allpayurl1 is at login=====${globals.Payurl}");
                                                      ...
                                                      try {
                                                        Future.delayed(
                                                          ...
                                                          if (trialink
                                                            ...
                                                            schlrquiz = '';
                                                            print(
                                                                'the schlrquiz after navigation is ${schlrquiz}');
                                                          } else if (allpayurl
                                                              .isNotEmpty) {
                                                            final cID =
